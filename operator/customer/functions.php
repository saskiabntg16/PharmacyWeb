...
if (isset($_POST['tambah'])) {
    ...
    $tambah_customer = mysqli_query($conn, "INSERT INTO customer (nama_customer, telp_customer) values('$nama_customer', '$telp_customer')");
    if ($tambah_customer) {
        echo "
        <script>
...
if (isset($_POST['edit'])) {
    ...
    $edit_customer = mysqli_query($conn, "UPDATE customer set nama_customer = '$nama_customer', telp_customer = '$telp_customer' WHERE id_customer = '$id_customer'");
    if ($edit_customer) {
        echo "
        <script>
